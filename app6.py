...
def show_statistics(original_data, noisy_data):
    st.write("元のデータの基本統計情報:")
    st.write(original_data.describe())
    
    st.write("ノイズが加えられたデータの基本統計情報:")
    st.write(noisy_data.describe())
    
    st.write("差分:")
    st.write(noisy_data.describe() - original_data.describe())
...
def main():
    ...
    if uploaded_file is not None:
        ...
        # 統計情報の表示
        show_statistics(data, st.session_state.noisy_data)
